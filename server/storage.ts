  ...
  async updateSystemSettings(id: number, data: any): Promise<any> {
    ...
    try {
      ...
      await this.db.run(updateQuery, [
        ...
        data.requireLowercase !== undefined ? data.requireLowercase : existingSettings.requireLowercase,
